...
conversion_dict = {
    ...
    "marketplacefeldkirch_station1_intensity_rgb.labels":
    "marketsquarefeldkirch1.labels",
    "marketplacefeldkirch_station4_intensity_rgb.labels":
    "marketsquarefeldkirch4.labels",
    "marketplacefeldkirch_station7_intensity_rgb.labels":
    ...
    "stgallencathedral_station1_intensity_rgb.labels":
    "stgallencathedral1.labels",
    "stgallencathedral_station3_intensity_rgb.labels":
    "stgallencathedral3.labels",
    "stgallencathedral_station6_intensity_rgb.labels":
